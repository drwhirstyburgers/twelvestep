...
ActiveRecord::Schema.define(version: 20181031222045) do
  ...
  create_table "steppers", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["chat_room_id"], name: "index_steppers_on_chat_room_id"
    t.index ["user_id"], name: "index_steppers_on_user_id"
  end
